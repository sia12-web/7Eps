...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Widget _buildHelpfulHint(String error) {
    ...
    if (error.contains('Invalid email or password')) {
      hint = '💡 Tip: Check for typos or try resetting your password';
    } else if (error.contains('verify your email')) {
      hint = '📧 Check your email inbox for the verification link';
    } else if (error.contains('already exists')) {
      hint = '→ Go to Sign In instead if you already have an account';
    } else if (error.contains('valid email')) {
      hint = '→ Make sure your email format is correct (e.g., you@example.com)';
    }
